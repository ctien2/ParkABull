...
export default function JarvisALotPage() {
    ...
    // Jarvis A Hall Parking lot coordinates (you can adjust these)
    const LOT_LATITUDE = 43.003791;
    const LOT_LONGITUDE = -78.788427;
    ...
    useEffect(() => {
        ...
        const fetchOccupancy = async () => {
            try {
                const response = await fetch('http://localhost:5001/api/lot/jarvisa?lot_name=Jarvis%20A', {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        <div className="flex h-screen w-full">
            ...
            <div className="w-96 h-full overflow-y-auto border-r bg-background">
                <div className="p-6 space-y-6">
                    <div>
                        <h1 className="text-3xl font-bold mb-2">Jarvis A Parking Lot</h1>
